...
public class Sidebar extends VBox implements UIComponent {
    ...
    public Sidebar() {
        ...
        SidebarButton feedbacksButton = new SidebarButton("Trip Feedbacks","feedback.png", List.of(RoleBLL.getAdminRole(), RoleBLL.getSecretaryRole()), e -> changeRoute(ScreensEnum.FEEDBACKS));
